...
```bash
git clone https://github.com/msaakaash/cine-verse.git
cd cine-verse
...
Replace the placeholder values with your actual **[OMDb API](https://www.omdbapi.com/)** and **[Appwrite](https://apwr.dev/JSM050)** credentials.
